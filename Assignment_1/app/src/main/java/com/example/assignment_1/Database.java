...
public class Database {
    ...
    static class Database_handler extends SQLiteOpenHelper {
        private static final String DATABASE_NAME = "COVID-19.db";    // Database Name
        ...
        private static final String CREATE_TABLE = "CREATE TABLE " + TABLE_NAME +
                " (" + UID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + HEART_RATE + " REAL, " + RESPIRATORY_RATE + " REAL, " + FEVER + " REAL ," + NAUSEA + " REAL, " + HEADACHE + " REAL, " + DIARRHEA + " REAL," + SOAR_THROAT + " REAL, " + MUSCLE_ACHE + " REAL, " + LOSS_OF_SMELL_OR_TASTE + " REAL, " + COUGH + " REAL, " + SHORTNESS_OF_BREATH + " REAL, " + FEELING_TIRED + " REAL );";
